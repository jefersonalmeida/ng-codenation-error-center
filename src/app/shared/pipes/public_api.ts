...
export { SafePipe } from './string/safe.pipe';
...
export { CpfPipe } from './string/cpf.pipe';
export { CnpjPipe } from './string/cnpj.pipe';
export { PhonePipe } from './string/phone.pipe';
export { DocumentPipe } from './string/document.pipe';
